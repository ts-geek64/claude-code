...
# AU Vodka Shopify Sync - Cloud Scheduler Deployment Script
# Creates a Cloud Scheduler job to trigger the Shopify sync function daily for AU Vodka tenant
...
echo "Deploying Cloud Scheduler job for AU Vodka Shopify Sync"
...
gcloud scheduler jobs create http "$JOB_NAME" \
  ...
  --description="Daily AU Vodka Shopify sync - runs at midnight EST"

...
SECRETS="DB_HOST=prod_omnigrowthos_database_postgres_host:latest"
SECRETS="$SECRETS,DB_PORT=prod_omnigrowthos_database_postgres_port:latest"
SECRETS="$SECRETS,DB_NAME=prod_omnigrowthos_database_postgres_database:latest"
SECRETS="$SECRETS,DB_USER=prod_omnigrowthos_database_postgres_user:latest"
SECRETS="$SECRETS,DB_PASSWORD=prod_omnigrowthos_database_postgres_password:latest"
